...
- \href{https://vasishth.github.io/bayescogsci/book/}{Nicenboim, B., Schad, D. \& Vasishth, S. \emph{An Introduction to Bayesian Data Analysis for Cognitive Science.}}
- \href{https://bookdown.org/content/3686/ordinal-predicted-variable.html}{Cap. 23 - Ordinal Predicted Variable. In. Kurz, S. \emph{Doing Bayesian Data Analysis in brms and the tidyverse.}}
...
data.frame(
  ...
  mutate(d = dlogis(y, mean, sd)) %>% # PDF da distribuição logística
  ggplot(aes(x = y, y = d, fill = fatores)) +
  geom_density(stat = "identity", alpha = 0.5,
               aes(color = fatores)) +
